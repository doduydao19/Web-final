...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" href="../css/room_regist_input.css">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Room regist input</title>
</head>
<body>
	<div class="form_center">
		<table class="table_form">
			<form method="POST" action="room_regist_input.php" enctype='multipart/form-data'>
				<tr>
