        ...
        <nav class="navbar navbar-expand fixed-top be-top-header">
            <div class="container-fluid">
                <div class="be-navbar-header">
                    ...
                    <a href="/admin/dashboard" style="font-size:18px; margin-left: 22px; color: gray">Device manage</a>
                </div>
                    ...
                    <ul class="nav navbar-nav float-right be-user-nav">
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="/assets/img/avatar.png" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
                            <div class="dropdown-menu" role="menu">
                                ...
                                </div><a class="dropdown-item" href="pages-profile.html"><span class="icon mdi mdi-face"></span>Account</a><a class="dropdown-item" href="#"><span class="icon mdi mdi-settings"></span>Settings</a><a class="dropdown-item" href="/logout"><span class="icon mdi mdi-power"></span>Logout</a>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="left-sidebar-scroll">
                        <div class="left-sidebar-content">
                            <ul class="sidebar-elements">
                                ...
                                <li><a href="/admin/dashboard"><i class="icon mdi mdi-home"></i><span>Dashboard</span></a>
                                </li>
                                <li><a href="/admin/class-room"><i class="icon mdi mdi-view-web"></i><span>Classroom</span></a>
                                </li>
                                <li><a href="/admin/teacher"><i class="icon mdi mdi-view-web"></i><span>Teacher</span></a>
                                </li>
                                <li><a href="/admin/device"><i class="icon mdi mdi-view-web"></i><span>Device</span></a>
                                </li>
                                <li><a href="/admin/transaction"><i class="icon mdi mdi-view-web"></i><span>Transaction</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
