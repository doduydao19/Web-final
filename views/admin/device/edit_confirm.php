    ...
    <div class="col-12">
        <div class="card card-border-color card-border-color-primary">
            ...
            <div class="card-body">
                ...
                <form action="/admin/device/edit_confirm?id=<?= $data->id ?>" method="POST">
                    ...
                    <a class="btn btn-primary btn-sm" href="/admin/device/edit?id=<?= $data->id ?>">Sửa lại</a>
                    <a class="btn btn-primary btn-sm" href="/admin/device/complete?id=<?= $data->id ?>">Đăng ký</a>
